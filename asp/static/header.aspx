...
<div class="box">
        ...
        <div class="hydl_an">
            <a href="hyzcsf.aspx">
                <img src="images/anniu_hyzc.jpg" width="96" height="30" /></a>
        </div>
        <div class="sous">
            ...
            <input type="submit" name="btnSubmit" value="" style="background: url('images/sss_03.jpg');
                width: 96px; height: 28px; margin-top: 1px; cursor: pointer;" />
            </form>
        </div>
        <%
        ...
        %>
        <div class="anniu">
            <a onclick='clickMe("gysdl.aspx")'>供应商登录</a></div>
        <div class="anniu">
            <a onclick='clickMe("cgsdl.aspx")'>采购商登录</a></div>
        <%      }
            //采购商登录
        ...
        <div class="anniu">
            <a href="gyszym.aspx" target="_self">供应商主页面</a></div>
        <%  }
            else if (Convert.ToString(gys_yh_id) == "" && Convert.ToString(cgs_yh_id) != "")
            {%>
        <div class="anniu">
            <a href="QQ_out.aspx" target="_self">采购商登出</a></div>
        <div class="anniu">
