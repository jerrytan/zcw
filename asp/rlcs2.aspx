    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (Session["GYS_YH_ID"] != null && Session["GYS_YH_ID"].ToString() != "")
        ...
        if (s_yh_id != "")
        {
             ...
             //{
                 ...
                 if (count == 0)  //认领的供应商不存在
                 {
                     ...
                     if (s_gys_id != "")
                     {
                         ...
                         string gys_type1 = Convert.ToString(dt_gysxx.Rows[0]["单位类型"]);
                         ...
                         + "联系人手机='" + user_phone + "',单位类型='" + gys_type1 + "',组织机构编号='" + zzjg_number + "',联系地址='" + lx_addrass + "',"
             ...
             //        {
             //              string gys_name = dt_gysxx.Rows[0]["供应商"].ToString();
             //        string homepage = dt_gysxx.Rows[0]["主页"].ToString();
             //        string tel = dt_gysxx.Rows[0]["电话"].ToString();
             //        string fax = dt_gysxx.Rows[0]["传真"].ToString();
             //        string user_name =dt_gysxx.Rows[0]["联系人"].ToString();
             //        string user_phone =dt_gysxx.Rows[0]["联系人手机"].ToString();
             //        string gys_type1 =dt_gysxx.Rows[0]["单位类型"].ToString();
             //        string zzjg_number =dt_gysxx.Rows[0]["组织机构编号"].ToString();
             //        string lx_addrass = dt_gysxx.Rows[0]["联系地址"].ToString();
             //        string scope = dt_gysxx.Rows[0]["经营范围"].ToString();
             //        string area =dt_gysxx.Rows[0]["地区名称"].ToString();
