...
<body>
  ...
  <asp:Label ID="shaixu" runat="server"><font style="FONT-SIZE: 9pt">检索条件：</font></asp:Label>
                    ...
                    <asp:Button ID="filter" runat="server" Text="检索" OnClick="filter_Click" CssClass="filter"
                        ...
                        &nbsp;
                      <input type="button" class="btnFilter" value="添加材料" onclick="btnFilter_Click()" style=" margin-top:0px; height: 20px;width: 64px; border-style: none; font-family: 宋体; font-size: 12px; cursor:pointer;" />&nbsp;
                      <input type="button" class="btnFilter" value="删除材料" onclick="delete_cl()" style=" margin-top:0px; height: 20px;width: 64px; border-style: none; font-family: 宋体; font-size: 12px; cursor:pointer;" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dddddd" class="table2" id="table4">
      ...
      <%{ %>
          ...
          <% if (i % 2 == 0)%>  
          <%{ %>   
             <tr style="background:#f2f6ff " onmouseover='this.style.backgroundColor="#fff0e9"' onmouseout='this.style.backgroundColor="#f2f6ff"' >
                <td align="center"><input type="checkbox" name="checkbox" onclick="return selectall1(this);"  />
                <label for="checkbox"></label></td>
                <td align="center" style="display:none;"> <%=dtcl.Rows[i]["cl_id"]%></td>
                <td align="center"><%=dtcl.Rows[i]["材料编码"]%></td>
                ...
                <td align="center">
                <input type="Button" name="filter" value="查阅"   class="filter" filter="" onclick="Read('<%=dtcl.Rows[i]["cl_id"] %>')"  style="color:Black;border-style:None;font-family:宋体;font-size:12px;height:20px;width:37px; cursor:pointer;"/>
                </td>
             </tr> 
             <%} %> 
             <%else %>
