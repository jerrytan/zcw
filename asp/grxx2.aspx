             ...
             {    		              			  
                 ...
                 //蒋，2014年8月22日修改sql语句	  
                  ...
                  //+ "QQ号码='" + user_qq + "',类型='" + scs_type + "',是否验证通过='待审核',等级='普通用户' where yh_id='" + s_yh_id + "' ";
                   sSQL = "update 用户表 set 手机='" + user_phone + "' where yh_id='" + s_yh_id + "'";
                  ...
                  if (user_qq != "")
                  {
                      ...
                      string str_insert = "insert into 材料供应商信息表(联系人,联系人手机,联系人QQ,是否启用,yh_id,审批结果)" +
                               " values('" + user_name + "','" + user_phone + "','" + user_qq + "','1','" + s_yh_id + "','通过')";
