...
<body>
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (pp_id != "")//Post进来
            {
                ...
                //Response.Write(pageIndex+","+pageSize+","+total+","+sSQL);
    ...
    <div id="jiansuo2">
        ...
        &nbsp;
        <input type="button" class="btnDelete1" value="新增材料" onclick="btnFilter_Click()"
            style="height: 20px; width: 72px; border-style: none; font-family: 宋体; font-size: 12px;
            cursor: pointer;" />&nbsp;
        <input type="button" class="btnDelete1" value="删除材料" onclick="delete_cl()" style="height: 20px;
            width: 72px; border-style: none; font-family: 宋体; font-size: 12px; cursor: pointer;" /></td>
    </div>
    ...
    <div id="divtable" runat="server" style="height: 230px">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dddddd"
            ...
            <thead>
                <tr>
                    <th width="42" align="center" style="font-size: 12px" class="style2">
                        <strong>选 择</strong>
                    </th>
                    <th width="125" align="center" style="font-size: 12px" class="style2">
                        <strong>材料名称</strong>
                    </th>
                    <th align="center" class="style2" style="font-size: 12px">
                        <strong>品 牌</strong>
                    </th>
                    <th width="85" align="center" style="font-size: 12px" class="style2">
                        <strong>规格\型号</strong>
                    </th>
                    <th width="55" align="center" style="font-size: 12px" class="style2">
                        <strong>编 码</strong>
                    </th>
                    <th width="255" align="center" style="font-size: 12px" class="style2">
                        <strong>供应商</strong>
                    </th>
                    <th width="53" align="center" style="font-size: 12px" class="style2">
                        <strong>操 作</strong>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td align="center">
                        <input type="checkbox" name="input" id="checkbox" value="<%=R_cl["cl_id"].ToString() %>" />
                        <label for="checkbox">
                        </label>
                    </td>
                    ...
                    <td align="center">
                        <input type="Button" name="input" value="编辑" id="filter" onclick="BJCL('<%=R_cl["cl_id"].ToString() %>','<%=R_cl["分类编码"].ToString()%>','<%=R_cl["分类名称"].ToString() %>','<%=R_cl["pp_id"].ToString() %>')"
                            class="filter" filter="" style="color: Black; border-style: None; font-family: 宋体;
                            font-size: 12px; height: 20px; width: 37px; cursor: pointer;" />
                    </td>
                </tr>
                <%}%>
