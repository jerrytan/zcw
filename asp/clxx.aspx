...
<body>
    <input type="hidden" name="clid" id="myclid" value="" runat="server" />
    <!-- 头部开始-->
    ...
    <div class="sc">
        ...
        <div class="bianqian">
            <div class="lib_spxq">
                <ul>
                    <li id="two1" onclick="setTab('two',1,4)" class="hover">产品详情</li>
                    <li id="two2" onclick="setTab('two',2,4)">相关文档</li>
                    <li id="two3" onclick="setTab('two',3,4)">相关视频</li>
                    <li id="two4" onclick="setTab('two',4,4)">分销商信息</li>
                </ul>
            </div>
            ...
            <div class="bq_cont" id="con_two_2" style="display: none;">
                <div class="wendang_cont">
                    <ul>
                        <li>
                            <img src="images/word.gif" width="16" height="16" />
                            标题：<b id="domName">地砖材质选择</b></li>
            ...
            <div class="bq_cont" id="con_two_3" style="display: none;">
                <div class="wendang_cont">
                    <ul>
                        <li>
                            <img src="images/video.gif" width="16" height="16" />
                            标题：<b id="videoName">地砖材质选择</b></li>
