...
<script runat="server">  
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da1 = new SqlDataAdapter("select 供应商,联系人,联系人手机,联系地址 from 材料供应商信息表 where gys_id in(select uid from 品牌字典 where pp_id='"+pp_id+"' )", conn);
...
<div class="gysxx"> 
<div class="gysxx1"><a href="index.aspx">首页 ></a>&nbsp&nbsp&nbsp
...
<div class="gydl"><div class="dlpp">该品牌分销商</div>
    <div class="fxs1"><select name="" class="fu1"><option>华北</option></select>  
...
<div class="gydl"><div class="dlpp">该品牌下产品</div>
...
<span class="ppcp2">规格：<%=row["规格型号"].ToString() %></span></div>
