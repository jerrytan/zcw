			...
			else   //采购商登录的情况
			{
				...
				{                 
					...
					try
					{
                        ...
                        {
                            string sql_scxx = @"insert into 采购商关注的材料表 (yh_id,cl_id,材料名称,材料编码,收藏时间,收藏人QQ,是否启用,dw_id,收藏人) 
                            values ('" + scryhid + "','" + str_clid + "','" + str_clmc + "','" + str_clbm + "',GETDATE(),'" + scrqq + "','1','" + scrdwid + "','" + scrxm + "')";
                            objConn.ExecuteSQL(sql_scxx, true);
                        }
                        else
                        {
                            //Response.Write("<script>alert('该材料已收藏');</script>");
                        }
                        ...
                        {
                            string sql_scgys = @"insert into 采购商关注供应商表 (yh_id,gys_id,供应商名称,收藏时间,收藏人QQ,是否启用,dw_id,收藏人)  
                            values ('" + scryhid + "','" + str_gysid + "','" + str_sccs + "',GETDATE(),'" + scrqq + "',1,'" + scrdwid + "','" + scrxm + "')";
                            objConn.ExecuteSQL(sql_scgys,true);
                        }
                        else
                        {
                            //Response.Write("<script>alert('该供应商已收藏');</script>");
                        }
