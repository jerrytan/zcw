...
<body>
    ...
    <div style="text-align: center;">
        <dd style="text-align: center; background-color: #cadbff; line-height: 24px;">
            <strong id="addpp" runat="server">增加新品牌</strong></dd>
        <table border="0" width="400px" style="text-align: center;">
            <br />
            <br />
            <tr>
                <td style="color: Black; height: 34px;">
                    品牌名称：
                </td>
                <td align="left">
                    <input type="text" id="brandname" runat="server" name="brandname" value="" style="margin: 0px 10px 0px 0px;
                        border: 1px solid Black; width: 198px; height: 20px; line-height: 20px; float: left;
                        display: inline;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top" style="color: Black; height: 34px;">
                    范围：
                </td>
                <td align="left">
            ...
            <tr>
                ...
                <td align="left">
                    <input type="checkbox" id="Checkbox1" onclick="ISQYs(this)" checked="checked" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td align="left" style="height: 34px;">
                    ...
                    <input type="submit" name="filter" value="保存" id="send" class="filter" filter=""
                        style="color: Black; border-style: None; font-family: 宋体; font-size: 12px; height: 20px;
                        width: 37px; cursor: pointer;" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button" name="filter" value="关闭" id="close" class="filter" filter=""
                        style="color: Black; border-style: None; font-family: 宋体; font-size: 12px; height: 20px;
                        width: 37px; cursor: pointer;" onclick="window.close();" />
                </td>
            </tr>
        </table>
    </div>
