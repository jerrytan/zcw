...
<body>
    ...
    <tr>
      ...
      <td width="329"><label for="textfield"></label>
        <input name="companyname" type="text" id="companyname" class="fxsxx3" value="<%=dt_gys.Rows[0]["供应商"]%>"/></td>
      <td width="50" align="right"></td>
      <td class="style12">公司地址：</td>
      <td><input name="address" type="text" id="address" class="fxsxx3" value="<%=dt_gys.Rows[0]["联系地址"]%>" /></td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
      <td class="style11">公司电话：</td>
      <td><input name="tel" type="text" id="tel" class="fxsxx3" value="<%=dt_gys.Rows[0]["电话"]%>"/></td>
      <td>&nbsp;</td>
      <td class="style12">公司主页:</td>
      <td><input name="homepage" type="text" id="homepage" class="fxsxx3" value="<%=dt_gys.Rows[0]["主页"]%>" /></td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
      <td class="style11">公司传真：</td>
      <td><input name="fax" type="text" id="fax" class="fxsxx3" value="<%=dt_gys.Rows[0]["传真"]%>" /></td>
      <td>&nbsp;</td>
      <td class="style12">公司地区：</td>
      <td><input name="area" type="text" id="area" class="fxsxx3" value="<%=dt_gys.Rows[0]["地区名称"]%>" /></td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
      <td class="style11">联系人姓名：</td>
      <td><input name="name" type="text" id="name" class="fxsxx3" value="<%=dt_gys.Rows[0]["联系人"]%>" /></td>
      <td>&nbsp;</td>
      <td class="style12">联系人电话：</td>
      <td><input name="phone" type="text" id="phone" class="fxsxx3" value="<%=dt_gys.Rows[0]["联系人手机"]%>" /></td>
    </tr>
    <tr>
      <td height="40">&nbsp;</td>
      <td class="style11">经验范围：</td>
      <td colspan="4" height="90px"><label for="textfield21"></label>
         <input name="Business_Scope" style="height:70px; width:770px;" type="text" id="Business_Scope" class="fxsxx3" value="<%=dt_gys.Rows[0]["经营范围"]%>" /></td>
    </tr>
  </table>
