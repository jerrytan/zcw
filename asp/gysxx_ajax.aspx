...
<script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gysid = int.Parse(Request["gysid"].ToString());
            ...
            else
            {
                ...
                //2.根据gys_id和地区名称，找到对应的分销商信息
                string str_sqlfxs = "select 供应商,联系人,联系人手机,联系地址,地区名称,gys_id from 材料供应商信息表 where gys_id in(select fxs_id from 分销商和品牌对应关系表 where pp_id in( select pp_id from 品牌字典 where scs_id =" + gysid + ")) and 联系地址 like '%" + str_dq + "%'";
