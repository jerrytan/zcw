                ...
                <div id="menu_lb">
                    ...
                    <span class="no">
                        ...
                        <ul class="no">
                            ...
                            <%  {%>
                            <li><a href="javascript:void(0)" onclick="lbs(this,'<%=drsj["分类编码"]%>','<%=(drsj["显示名字"])%>','<%=drsj["单位"]%>')">
                                <%=drsj["显示名字"]%></a></li>
                            <%  } %>
                        </ul>
                        <%} %>
                        ...
                        <%{ %>
                        <h2>
                            <a href="javascript:void(0)" onclick="lbs(this,'<%=drej["分类编码"]%>','<%=(drej["显示名字"])%>','<%=drej["单位"]%>')">
                                <%=drej["显示名字"]%></a></h2>
                        <ul class="no">
                        </ul>
                        <%} %>
                    ...
                    <%{ %>
                    <h1>
                        <a href="javascript:void(0)" onclick="lbs(this,'<%=dryj["分类编码"]%>','<%=(dryj["显示名字"])%>','<%=dryj["单位"]%>')">
                            <%=dryj["显示名字"]%></a></h1>
                    <span class="no"></span>
                    <%} %>
                    <% firstlevel++;  %>
