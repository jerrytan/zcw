...
<script runat="server">
		    ...
		    protected void Page_Load(object sender, EventArgs e)
            {
              ...
              sSQL="select 分类编码 from 材料分类属性值表 where flsx_id='"+flsx_id+"'";    //分类 属性
			   ...
			   sSQL="select 编号,属性值,flsxz_id from 材料分类属性值表 where 是否启用=1 and 分类编码='"+clflsx_id+"' and flsx_id='"+flsx_id+"' order by 属性编码,编号";    //分类 属性
